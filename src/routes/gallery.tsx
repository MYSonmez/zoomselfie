      ...
      <section className="relative flex min-h-[100svh] items-center overflow-hidden bg-primary pb-14 pt-24 sm:pt-28 lg:pb-20">
        ...
        <div className="container-page relative z-10 grid w-full items-center gap-14 lg:grid-cols-[.82fr_1.18fr] lg:gap-10">
          ...
          <motion.div initial={reduceMotion ? false : { opacity: 0, scale: .96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: .85, delay: .08 }} className="relative mx-auto h-[500px] w-full max-w-[680px] sm:h-[610px]">
            <div className="absolute left-[2%] top-[12%] h-[58%] w-[42%] rotate-[-5deg] overflow-hidden rounded-[1.8rem] border-[6px] border-white bg-white shadow-2xl"><Image src={galleryParisCouple} alt="ZoomSelfie photo example" className="h-full w-full object-cover" /></div>
            <div className="absolute right-[2%] top-[2%] h-[45%] w-[46%] rotate-[4deg] overflow-hidden rounded-[1.8rem] border-[6px] border-white bg-white shadow-2xl"><Image src={galleryIstanbulGroup} alt="ZoomSelfie photo example" className="h-full w-full object-cover" /></div>
            <div className="absolute bottom-[2%] right-[9%] h-[48%] w-[47%] rotate-[-2deg] overflow-hidden rounded-[1.8rem] border-[6px] border-white bg-white shadow-2xl"><Image src={galleryCruiseSunset} alt="ZoomSelfie photo example" className="h-full w-full object-cover" /></div>
            <div className="absolute bottom-[5%] left-[12%] h-[32%] w-[30%] rotate-[6deg] overflow-hidden rounded-[1.5rem] border-[5px] border-white bg-white shadow-2xl"><Image src={gallerySkiSolo} alt="ZoomSelfie photo example" className="h-full w-full object-cover" /></div>
          </motion.div>
        </div>
      </section>
